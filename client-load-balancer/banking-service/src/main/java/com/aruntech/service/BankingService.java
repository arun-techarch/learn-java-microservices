...
public class BankingService {
    ...
    private String CUSTOMER_ENDPOINT_URL = "http://customer-service/customer";
    ...
    public AccountCreateResponse createNewAccount(final AccountCreateRequest request) {
        ...
        Customer customer = restTemplate.postForObject(CUSTOMER_ENDPOINT_URL, payload, Customer.class);
    ...
    private TransactionResponse updateBalance(final Customer customer, final double amount, TransactionType transactionType) {
        ...
        //call the service
        restTemplate.put(CUSTOMER_ENDPOINT_URL+"/"+customer.getId(), payload);
        Customer response = restTemplate.getForObject(CUSTOMER_ENDPOINT_URL+"/"+customer.getId(), Customer.class);
