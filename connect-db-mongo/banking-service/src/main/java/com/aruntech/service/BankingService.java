...
public class BankingService {
    ...
    @Autowired
    private BankingSeqGenerator seqGenerator;
    @Autowired
    ...
    public TransactionResponse deposit(final TransactionRequest request) throws ExecutionException, InterruptedException {
    ...
    private TransactionResponse updateBalance(final Customer customer, final double amount, TransactionType transactionType) throws ExecutionException, InterruptedException {
        //prepare the payload
        ...
        //call the service
        restTemplate.put(CUSTOMER_ENDPOINT_URL+"/"+customer.getId(), payload, Customer.class);
        Customer response = getCustomerInfo(customer.getId());
    ...
    private BankingTransaction getBankingTransaction(final Customer customer, final double amount, TransactionType transactionType) {
        ...
        transaction.setId(seqGenerator.getSequence(BankingTransaction.BANKING_TRANSACTION_SEQ));
